#tinker is used to make Graphical User Interface applications
import tkinter
#Image,Imagetk used to perform operations invoving images in our UI
...
HeadingLabel = tkinter.Label(root, text="Hello from Gamers!",
   fg = "light green",
     bg = "dark green",
